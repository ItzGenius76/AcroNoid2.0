export default class OrasConfig extends Object {
    ...
    constructor() {
        super();
        this.token = process.env.TOKEN || ""; // Access token from environment variable
        this.prefix = ">";
        this.nodes = [
            {
                name: `Kronix`,
            ...
            },
          {
              ...
              auth: `kronix`,
              secure: false,
          }, // Don't Change The Name Of Nodes
        ];
        this.voteApi = "";
        this.webhooks = {
        ...
        this.owners = [""];//put your discord id
        this.color = "#880808";
        ...
        this.setupBgLink = "https://media.discordapp.net/attachments/1190943041922535517/1190943144158691369/live_now.png?ex=65a3a33c&is=65912e3c&hm=3f442c1bd2f8b61e3be1f1c625d891df2b90334098765ca174750746912df20d&=&format=webp&quality=lossless&width=1000&height=562";
    }
}
